...
input_type = st.radio(
    "What do you have?",
    options=["Audio (.wav) to Audio (.wav) translation", "Subtitles (.srt) to Audio (.wav) translation"],
    horizontal=True
)
...
if input_type == "Audio (.wav) to Audio (.wav) translation":
...
if st.button("Process Audio" if input_type == "Audio (.wav) to Audio (.wav) translation" else "Generate Audio"):
