...
#     """
#     try:
#         audio, sample_rate = librosa.load(audio_file, sr=None) # sr needs to be none otherwise it resamples to 22050
#         duration = len(audio) / sample_rate
#         duration_rounded_down = math.floor(duration)
#         print(sample_rate)
#         # custom_hop_length = (sample_rate/2)*(duration_rounded_down/(duration_rounded_down-1))
#         # sanitized_custom_hop_length = math.floor(custom_hop_length)
#         mfcc = librosa.feature.mfcc(y=audio, sr=sample_rate, hop_length=sample_rate, center=False)
...
#         print(duration_rounded_down)
#         # print(sanitized_custom_hop_length)
...
#     cluster_labels = count_speakers(audio_file, num_speakers)
