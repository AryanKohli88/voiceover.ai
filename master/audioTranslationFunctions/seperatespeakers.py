...
audio_file = "./audio_to_translate/vocals.wav"
...
# 6. Export results
speaker_tracks["SPEAKER_00"].export("./audio_to_translate/speaker1.wav", format="wav")
speaker_tracks["SPEAKER_01"].export("./audio_to_translate/speaker2.wav", format="wav")
